...
Тут перечислены условия, которые необходимо соблюдать при составлении конфигурационных файлов sing-box для роутера, а так же необходимые настройки в веб-интерфейсе роутера.
 ...
 1. Общие условия:
  ...
  1.3 Не используйте в config.json настройку '"auto_detect_interface": true', на роутере она некорректно определяет интерфейс для direct outbound, что вызывает отсутствие доступа через sing-box к ресурсам в домашней сети.
