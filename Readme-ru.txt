...
I. Основы.
 ...
 4. К вашему роутеру должен быть подключен USB-накопитель с установленным Entware, в нём будет установлено ядро sing-box. Установка ядра во внутреннюю память роутера не желательна, а иногда и невозможна из-за её ограничений, и не рассматривается.
