...
Тут перечислены условия, которые необходимо соблюдать при составлении конфигурационных файлов sing-box для роутера, а так же необходимые настройки в веб-интерфейсе роутера.
 ...
 1. Общие условия:
  ...
  При некоторых комбинациях правил и выборе во внешней панели* в разделе Config какого либо Mode, кроме Rule, это вызывает почти моментальное поглощение всей оперативной памяти процессом sing-box и зависание роутера.
