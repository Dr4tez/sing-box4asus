...
I. Основы.
 ...
 2. Поддерживаются только роутеры с архитектурами процессоров ARM/AArch (можете узнать выполнив команду 'uname -m' в консоли роутера) и версией ядра системы не ниже 4.0 (можете узнать выполнив команду 'uname -r' в консоли роутера).
