...
Configuration file templates for sing-box 1.12.* cores for all the variants listed below can be found on the project page https://github.com/Dr4tez/sing-box4asus. If you want to use one of them with other sing-box core versions, don't forget to change the config according to the Migration section of the sing-box documentation https://sing-box.sagernet.org/migration/ if necessary.
