...
4. Если вам необходим доступ из интернета к какому-либо устройству в сети вашего роутера через переадресацию портов, то не добавляйте IP-адрес этого устройства при настройке скрипта, иначе доступа к нему не будет.
5. У вас в роутере должна быть примонтированная флешка с установленным на ней Entware. В ней будет установлено ядро sing-box, которым, в процессе его работы, там же будут созданы директория с UI и cache файл. Установка данных компонентов во внутреннюю память роутера не желательна, а часто и невозможна из-за её ограничений, и не рассматривается.
